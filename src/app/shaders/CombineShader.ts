export const COMBINE_FRAGMENT_SHADER_ENTRY_NAME = 'combine'

export const COMBINE_FRAGMENT_SHADER_SRC = /* wgsl */ `
  ...
  @fragment
  fn ${COMBINE_FRAGMENT_SHADER_ENTRY_NAME}(@builtin(position) coord : vec4f) -> @location(0) vec4f {
